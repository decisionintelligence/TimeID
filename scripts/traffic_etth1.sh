...
source_data_path_name=traffic.csv
model_id_name=ETTh1
data_name=ETTh1
source_data_name=traffic
...
do
    nohup python -u main.py \
      ...
      --batch_size 128 >logs/LongForecasting/$source_data_name'_'$model_id_name'_'$seq_len'_'$pred_len.log 2>&1 &
