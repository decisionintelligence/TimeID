...
source_data_path_name=weather.csv
model_id_name=Electricity
data_name=custom
source_data_name=weather
...
do
    nohup python -u main.py \
      ...
      --IIC_PAR 1e-3 \
      --source_batch_size 4 \
      --batch_size 4 >logs/LongForecasting/$source_data_name'_'$model_id_name'_'$seq_len'_'$pred_len.log 2>&1 &
done